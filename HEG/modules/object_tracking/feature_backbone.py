    ...
    def __init__(
        ...
        if download:
            state_dict = load_state_dict_from_url(
                "https://download.pytorch.org/models/resnet101-5d3b4d8f.pth", model_dir=str(backbone_weights_dir), progress=True
            )
...
class ResNetBackbone(nn.Module):
    def __init__(
        ...
        if pretrained:
            state_dict = load_state_dict_from_url("https://download.pytorch.org/models/resnet101-5d3b4d8f.pth", model_dir=model_dir, progress=progress)
